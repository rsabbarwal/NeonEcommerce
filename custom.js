...
var favcolor1 = document
  .getElementById("favcolor1")
  .addEventListener("click", () => {
    var showMsg = document.getElementById("showMsg");
...
var favcolor2 = document
  .getElementById("favcolor2")
  .addEventListener("click", () => {
    var showMsg = document.getElementById("showMsg");
...
var favcolor3 = document
  .getElementById("favcolor3")
  .addEventListener("click", () => {
    var showMsg = document.getElementById("showMsg");
...
var favcolor4 = document
  .getElementById("favcolor4")
  .addEventListener("click", () => {
    var showMsg = document.getElementById("showMsg");
